        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
          ...
          <div className="hidden md:flex items-center space-x-1">
            {navLinks.map((link, index) => (
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="relative px-4 py-2 text-gray-700 hover:text-blue-600 transition-colors font-medium text-sm group"
              >
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <Link
                to="/get-started"
                className="relative px-5 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm font-semibold rounded-lg overflow-hidden group shadow-md hover:shadow-xl transition-all duration-300"
              >
              ...
              <motion.button
                ...
                className={`p-2.5 rounded-lg border transition-all duration-300 ${
                  isUserMenuOpen
                    ...
                    : "bg-white/80 text-gray-700 border-gray-200 hover:border-blue-600 hover:text-blue-600"
                }`}
              >
              ...
              <AnimatePresence>
                {isUserMenuOpen && (
                  <motion.div
                    ...
                    className="absolute right-0 mt-2 w-56 bg-white/95 backdrop-blur-xl rounded-xl shadow-2xl border border-gray-200/50 overflow-hidden"
                  >
                    <div className="py-2">
            ...
            <motion.button
              ...
              className="md:hidden p-2.5 rounded-lg bg-white/80 text-gray-700 border border-gray-200 hover:border-blue-600 hover:text-blue-600 transition-all"
            >
